...
namespace GiantOctopusVR.ARController  
{
    ...
    public class ARController : MonoBehaviour
    {
        ...
        public void Update ()
        {
            ...
            if (Session.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), raycastFilter, out hit))
            {
                ...
                Debug.Log("bekitAR: Hit point: " + hit.Point.ToString());

                // Use a plane attachment component to maintain the world's offset from the plane
                // (occurs after anchor updates).
                worldObject.AddComponent<PlaneAttachment>();
